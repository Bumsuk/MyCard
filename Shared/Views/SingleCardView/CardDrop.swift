...
// 드래그 앤 드롭한 이미지를 카드 참조에 추가
struct CardDrop: DropDelegate {
    @Binding var card: Card
    var size: CGSize = .zero // for challenge
    var frame: CGRect = .zero // for challenge
    ...
    func calculateOffset(location: CGPoint) -> CGSize {
        ...
        // surrounding the card  static let cardSize = CGSize(width: 1300, height: 2000)
